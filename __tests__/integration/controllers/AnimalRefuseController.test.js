...
describe('Animal Refuse Controller Test', () => {
  beforeAll(async () => {
  ...
  it('should be able to refuse a animal', async () => {
    const response = await request(app)
      .patch(`/test/admin/animal/refuse/${animal_id}`)
      .send({
        id: uuid(),
        message: 'Wrong animal photo',
      })
      .set('Authorization', `Bearer ${admin_token}`);
  ...
  it('should not be able to refuse a animal without a reject message', async () => {
    const response = await request(app)
      .patch(`/test/admin/animal/refuse/${animal_id}`)
      .set('Authorization', `Bearer ${admin_token}`);
  ...
  it('should not be able refuse a animal with a non-admin', async () => {
  ...
  it('should not be able refuse a animal with a non-admin ong ', async () => {
